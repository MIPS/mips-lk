...
/* BAD MANIFEST test: pass in NULL instead of tee_api_properties */
tee_api_properties_t TEE_API_PROP_ATTRS tee_api_properties =
{
    { "gpd.ta.description", TA_PROP_TYPE_STR, "bad_manifest"},
};
...
trusty_app_manifest_t TRUSTY_APP_MANIFEST_ATTRS trusty_app_manifest =
{
    ...
    /* optional configuration options here */
    {
        ...
        TRUSTY_APP_CONFIG_EXTERN((uint32_t)NULL, (uint32_t)&ta_props_len),
    },
};
