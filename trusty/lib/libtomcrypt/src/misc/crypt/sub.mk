...
srcs-y += crypt_init.c
srcs-y += crypt_ltc_mp_descriptor.c
srcs-y += crypt_prng_descriptor.c
srcs-y += crypt_prng_rng_descriptor.c
srcs-y += crypt_prng_is_valid.c
srcs-y += crypt_register_all_cipher.c
srcs-y += crypt_register_all_hash.c
srcs-y += crypt_register_all_prng.c
srcs-y += crypt_register_cipher.c
srcs-y += crypt_register_hash.c
srcs-y += crypt_register_prng.c
srcs-y += crypt_sizes.c
